...
window.RetweetJS = {
	...
	bitly_user: "randallagordon",

	// Your Bit.ly API Key
	// Found here: http://bit.ly/account
	bitly_key: "R_bc7f245e9cf614211f7c44d2ed397321",
	...
	prefix: "RT @randallagordon ",

	// Style information
	styling: "a.retweet { font: 12px Helvetica,Arial; color: #000; text-decoration: none; border: 0px; }" +
		"a.retweet span { color: #FFF; background: #c00; margin-left: 2px; border: 1px solid #a00; -moz-border-radius: 3px; -webkit-border-radius: 3px; border-radius: 3px; padding: 3px; }" +
